    ...
    render() {
      ...
      <div class="view-container flex flex-col items-center justify-center min-h-full px-16 py-12">
        ...
        <div class="w-full max-w-2xl mb-6">
          <button class="btn btn-ghost text-green-400/70 gap-2" onclick="App.navigate('home')">
        ...
        <div class="w-full max-w-2xl glass-card p-12 rounded-3xl text-center">
          <!-- Icon -->
          <div class="w-24 h-24 mx-auto mb-6 rounded-2xl bg-green-500/20 border border-green-400/30 flex items-center justify-center">
          ...
          <h2 class="text-4xl font-bold text-green-100 mb-2">Identify Yourself</h2>
          <p class="text-green-400/70 text-lg mb-10">Enter your Student NFC Card ID to continue</p>

          <!-- NFC Input -->
          <div class="space-y-6">
            <div class="relative">
              <label class="block text-green-400 text-sm font-semibold uppercase tracking-wider mb-2 text-left">Student NFC Card ID</label>
              <input id="nfc-input"
                type="text"
                class="kiosk-input w-full"
          ...
          <!-- Hint -->
          <p class="text-green-600/60 text-sm mt-8">
